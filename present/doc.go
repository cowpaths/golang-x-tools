...
which can be slide presentations as in github.com/cowpaths/golang-x-tools/cmd/present
...
*/
package present // import "github.com/cowpaths/golang-x-tools/present"
