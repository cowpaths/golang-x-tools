...
github.com/cowpaths/golang-x-tools/go/cfg); the "inspect" analyzer returns a value that
...
entirety as:
	...
	import (
		"github.com/cowpaths/golang-x-tools/go/analysis/passes/findcall"
		"github.com/cowpaths/golang-x-tools/go/analysis/singlechecker"
	)
