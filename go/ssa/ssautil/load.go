...
import (
	...
	"github.com/cowpaths/golang-x-tools/go/loader"
...
// github.com/cowpaths/golang-x-tools/go/packages.Load function in LoadSyntax or
// LoadAllSyntax mode.
//
...
//
// The packages must have been loaded from source syntax using the
// github.com/cowpaths/golang-x-tools/go/packages.Load function in LoadAllSyntax mode.
//
...
// The mode parameter controls diagnostics and checking during SSA construction.
//
// Deprecated: Use github.com/cowpaths/golang-x-tools/go/packages and the Packages
