...
import (
	...
	"github.com/cowpaths/golang-x-tools/go/gcexportdata"
	...
	"github.com/cowpaths/golang-x-tools/internal/typesinternal"
)
...
func (ld *loader) loadFromExportData(lpkg *loaderPackage) (*types.Package, error) {
	...
	if viewLen != len(view) {
		log.Panicf("github.com/cowpaths/golang-x-tools/go/packages: unexpected new packages during load of %s", lpkg.PkgPath)
	}
