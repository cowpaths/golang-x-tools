...
import (
	...
	"github.com/cowpaths/golang-x-tools/internal/lsp/foo" //@link(`github.com/cowpaths/golang-x-tools/internal/lsp/foo`,`https://pkg.go.dev/github.com/cowpaths/golang-x-tools/internal/lsp/foo?utm_source=gopls`)
