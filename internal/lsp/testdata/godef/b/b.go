...
import (
	myFoo "github.com/cowpaths/golang-x-tools/internal/lsp/foo" //@mark(myFoo, "myFoo"),godef("myFoo", myFoo)
	"github.com/cowpaths/golang-x-tools/internal/lsp/godef/a"   //@mark(AImport, re"\".*\"")
)
