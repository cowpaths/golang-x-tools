...
import (
	...
	"github.com/cowpaths/golang-x-tools/internal/lsp/baz"
	_ "github.com/cowpaths/golang-x-tools/internal/lsp/signature" // provide type information for unimported completions in the other file
)
