...
// Options is github.com/cowpaths/golang-x-tools/imports.Options with extra internal-only options.
type Options struct {
...
// Process implements github.com/cowpaths/golang-x-tools/imports.Process with explicit context in opt.Env.
