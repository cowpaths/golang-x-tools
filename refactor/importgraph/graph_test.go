...
const this = "github.com/cowpaths/golang-x-tools/refactor/importgraph"

func TestBuild(t *testing.T) {
	exported := packagestest.Export(t, packagestest.GOPATH, []packagestest.Module{
		{Name: "github.com/cowpaths/golang-x-tools/refactor/importgraph", Files: packagestest.MustCopyFileTree(".")}})
